...
```{r august files}
aug_status_files <- list.files("P:/Rudolph/Datasets/EVSE-Status-Data", pattern = "^evse_statuses_2025-08", full.names = TRUE)

aug_output_file <- file.path("C:/Users/santar_r/Documents/Rudolph_local/Datasets/Switzerland/Processed-data/2025-08-charging.csv")

combine_status_files(aug_status_files, aug_output_file)
```