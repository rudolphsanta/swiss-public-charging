...
raw_data_root <- file.path("M:/Rudolph/0-Datasets/Switzerland/Swiss-EVChg-Data")
...
```{r}
#Again, this can run without changes, the code checks what already exists in the destination folder
