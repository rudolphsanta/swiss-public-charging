...
files_in_partial <- 2
partials_in_chunk <- 2
files_in_chunk <- files_in_partial * files_in_chunk
...
#visualization
plot(result$hour, result$median*100, type = 'l', col = 'black', 
     xlab = "hour", ylab = "utilization [%]", ylim = c(0,20))
lines(result$hour, result$lower_bound*100, type = 'l', col = 'red')
lines(result$hour, result$upper_bound*100, type = 'l', col = 'red')
